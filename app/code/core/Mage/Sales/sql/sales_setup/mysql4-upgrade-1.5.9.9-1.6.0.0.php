...
$tables = array(
    ...
    $installer->getTable('sales/quote_item') => array(
        ...
        'comment' => 'Sales Flat Article Item'
    ),
    $installer->getTable('sales/quote_address') => array(
        ...
        'comment' => 'Sales Flat Article Address'
    ),
    $installer->getTable('sales/quote_address_item') => array(
        'columns' => array(
            ...
            'quote_address_id' => array(
                ...
                'unsigned'  => true,
                'nullable'  => false,
                'comment'   => 'Article Address Id'
            ),
            'quote_item_id' => array(
                'type'      => Varien_Db_Ddl_Table::TYPE_INTEGER,
                'unsigned'  => true,
                'nullable'  => false,
                'comment'   => 'Article Item Id'
            ),
            'created_at' => array(
                'type'      => Varien_Db_Ddl_Table::TYPE_TIMESTAMP,
                'nullable'  => false,
        ...
        'comment' => 'Sales Flat Article Address Item'
    ),
    $installer->getTable('sales/quote_item_option') => array(
        ...
        'comment' => 'Sales Flat Article Item Option'
    ),
    $installer->getTable('sales/quote_payment') => array(
        ...
        'comment' => 'Sales Flat Article Payment'
    ),
    $installer->getTable('sales/quote_address_shipping_rate') => array(
        ...
        'comment' => 'Sales Flat Article Shipping Rate'
    ),
