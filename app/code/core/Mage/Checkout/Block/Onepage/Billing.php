...
class Mage_Checkout_Block_Onepage_Billing extends Mage_Checkout_Block_Onepage_Abstract
{
    ...
    /**
     * Return Sales Article Address model
     *
     ...
     * If Sales Article Address First Name is not defined - return Customer First Name
     *
     * @return string
     */
     ...
     * If Sales Article Address Last Name is not defined - return Customer Last Name
     *
     * @return string
     */
     ...
     * If Sales Article Address Middle Name is not defined - return Customer Middle Name
     *
     * @return string | NULL
     */
    ...
    /**
     * Check is Article items can ship to
     *
     * @return boolean
     */
