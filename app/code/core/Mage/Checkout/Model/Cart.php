...
class Mage_Checkout_Model_Cart extends Varien_Object implements Mage_Checkout_Model_Cart_Interface
{
     ...
     * $updatingParams - information on how to perform update, passed to Article->updateItem() method
     *
     * @param int $itemId
    ...
    public function updateItem($itemId, $requestInfo = null, $updatingParams = null)
    {
        try {
            $item = $this->getQuote()->getItemById($itemId);
            if (!$item) {
                Mage::throwException(Mage::helper('checkout')->__('Article item does not exist.'));
            }
